...
clear all;
%% weight calculation
function_range=1:57; %[1:57];%[1:57];%[1:33,44:50];
...
A1 = xlsread('20230620/[0.1]_Comparison_SASS_CMODE.xlsx',1); %A1 = xlsread('20230620/01_Result_Format_For_Comparison_[from 1 to 57].xlsx',1);
A2 = xlsread('20230620/[0.1]_Comparison_SASS_CMODE.xlsx',2); %A2 = xlsread('20230620/01_Result_Format_For_Comparison_[from 1 to 57].xlsx',1);
B1 = xlsread('20230620/[0.2]_Comparison_SASS_CMODE.xlsx',1);
B2 = xlsread('20230620/[0.2]_Comparison_SASS_CMODE.xlsx',2);
C1 = xlsread('20230620/[0.3]_Comparison_SASS_CMODE.xlsx',1); %C1 = xlsread('20230620/03_Result_Format_For_Comparison_[from 1 to 57].xlsx',1);
C2 = xlsread('20230620/[0.3]_Comparison_SASS_CMODE.xlsx',2); %C2 = xlsread('20230620/03_Result_Format_For_Comparison_[from 1 to 57].xlsx',2);
D1 = xlsread('20230620/[0.4]_Comparison_SASS_CMODE.xlsx',1);
D2 = xlsread('20230620/[0.4]_Comparison_SASS_CMODE.xlsx',2);
E1 = xlsread('20230620/[0.5]_Comparison_SASS_CMODE.xlsx',1); %E1 = xlsread('20230620/05_Result_Format_For_Comparison_[from 1 to 57].xlsx',1);
E2 = xlsread('20230620/[0.5]_Comparison_SASS_CMODE.xlsx',2); %E2 = xlsread('20230620/05_Result_Format_For_Comparison_[from 1 to 57].xlsx',2);
F1 = xlsread('20230620/[0.6]_Comparison_SASS_CMODE.xlsx',1);
F2 = xlsread('20230620/[0.6]_Comparison_SASS_CMODE.xlsx',2);
G1 = xlsread('20230620/[0.7]_Comparison_SASS_CMODE.xlsx',1); %G1 = xlsread('20230620/07_Result_Format_For_Comparison_[from 1 to 57].xlsx',1);
G2 = xlsread('20230620/[0.7]_Comparison_SASS_CMODE.xlsx',2); %G2 = xlsread('20230620/07_Result_Format_For_Comparison_[from 1 to 57].xlsx',2);
H1 = xlsread('20230620/[0.8]_Comparison_SASS_CMODE.xlsx',1);
H2 = xlsread('20230620/[0.8]_Comparison_SASS_CMODE.xlsx',2);
I1 = xlsread('20230620/[0.9]_Comparison_SASS_CMODE.xlsx',1);
I2 = xlsread('20230620/[0.9]_Comparison_SASS_CMODE.xlsx',2);
