function Draw_The_Optimizing_Process_v3(History,lb,ub,option,name)
...
switch option
    case 'movie'
        ...
        for i_frame=1:History.iter
            ...
            [X,Y]=pol2cart(History.Deg{i_frame},History.DistanceFromCOD{i_frame}+1.0e-8);
            %griddata(X,Y)
            p2=plot3(X,Y,History.obj{i_frame},'o','Color',[0.9,0.2,0.2],'MarkerFaceColor',[0.9,0.2,0.2],'MarkerSize',4);
            ...
            set(gca,'ZScale','log')
            nexttile(4)
            p3=polarplot(History.Deg{i_frame},History.DistanceFromCOD{i_frame}+1.0e-8,'o','Color',[0.9,0.2,0.2],'MarkerFaceColor',[0.9,0.2,0.2],'MarkerSize',4);
            hold on
            drawnow
            ...
            plot3(X,Y,History.obj{i_frame},'o','Color',[0.8,0.8,0.8],'MarkerFaceColor',[0.8,0.8,0.8],'MarkerSize',4);
            nexttile(4)
            delete(p3)
            polarplot(History.Deg{i_frame},History.DistanceFromCOD{i_frame}+1.0e-8,'o','Color',[0.8,0.8,0.8],'MarkerFaceColor',[0.8,0.8,0.8],'MarkerSize',4)
        end
